...
class Kaizen(models.Model):
    ...
    # 5M & Safety Impact Assessment (stored as JSON from committee review)
    impact_assessment_data = models.JSONField(
        null=True,
        blank=True,
        default=None,
        help_text='5M, Safety, PFD, PFMEA impact assessment data from committee review'
    )
